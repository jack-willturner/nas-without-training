...
parser.add_argument(
    "--data_loc", default="../cifardata/", type=str, help="dataset folder"
)
parser.add_argument(
    "--api_loc",
    default="../NAS-Bench-201-v1_0-e61699.pth",
    type=str,
    help="path to API",
)
parser.add_argument(
    "--save_loc", default="results/ICML", type=str, help="folder to save results"
)
parser.add_argument(
    "--save_string", default="naswot", type=str, help="prefix of results file"
)
parser.add_argument(
    "--score", default="hook_logdet", type=str, help="the score to evaluate"
)
parser.add_argument(
    "--nasspace", default="nasbench201", type=str, help="the nas search space to use"
)
...
for N in runs:
    ...
    for arch in indices:
        try:
            ...
            s = get_score_func(args.score)(x, target, network)
...
dset = (
    args.dataset
    if not (args.trainval and args.dataset == "cifar10")
    else "cifar10-valid"
)
